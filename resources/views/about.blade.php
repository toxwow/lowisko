        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4">
                <div class="wrapper-values">
                    ...
                    <p class="desc">Właściciel obiektu posiada 25 lat doświadczenia w branży rybackiej. Jest to gwarancja, iż obiekt każdego dnia jest profesjonalnie przygotowany do wędkowania, a ryby w zbiorniku są zdrowe i piękne. </p>
                </div>
            </div>
            <div class="col-12 col-md-4">
                <div class="wrapper-values">
